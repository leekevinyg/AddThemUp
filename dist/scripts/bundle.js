...
var AnswerFrame = React.createClass({displayName: "AnswerFrame",
  render: function() {
    ...
    var selectedNumbers = props.selectedNumbers.map(function(selectedNumber) {
      return (
        React.createElement("span", {onClick: props.clickNumber.bind(null, selectedNumber)}, 
          selectedNumber
        )
      );
    });
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {id: "button-frame"}, 
        React.createElement("button", {className: "btn btn-primary btn-lg", disabled: disabled, onClick: this.props.validateAnswer}, 
          "="
        )
      )
    );
...
var NumbersFrame = React.createClass({displayName: "NumbersFrame",
  render: function() {
    ...
    for (var i = 1; i <= 9; i++) {
      ...
      numbers.push(
        React.createElement("div", {className: className, onClick: clickNumber.bind(null, i)}, 
          i
        )
      );
    }
    ...
    render: function() {
      ...
      return (
        React.createElement("div", {id: "game"}, 
          React.createElement("h2", null, "Add them up!"), 
          React.createElement("hr", null), 
          React.createElement("div", {className: "clearfix"}, 
            React.createElement(StarsFrame, {numberOfStars: numberOfStars}), 
            React.createElement(ButtonFrame, {selectedNumbers: selectedNumbers, validateAnswer: this.validateAnswer}), 
            React.createElement(AnswerFrame, {selectedNumbers: selectedNumbers, clickNumber: this.removeNumberClick})
          ), 

          React.createElement(NumbersFrame, {selectedNumbers: selectedNumbers, clickNumber: this.addNumberClick})
        )
      );
    }
  });
...
},{"./components/AnswerFrame.js":158,"./components/ButtonFrame.js":159,"./components/Card.js":160,"./components/NumbersFrame.js":161,"./components/StarsFrame.js":162,"jquery":2,"react":157}]},{},[163]);
